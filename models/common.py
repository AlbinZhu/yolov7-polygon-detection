...
from utils.general import non_max_suppression, make_divisible, scale_coords, increment_path, xyxy2xywh, polygon_non_max_suppression
from utils.plots import color_list, plot_one_box, polygon_plot_one_box
